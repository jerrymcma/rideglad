  ...
  useEffect(() => {
    ...
    markers.forEach((markerData, index) => {
      ...
      const marker = new (window as any).google.maps.Marker({
        ...
        label: isDriver ? undefined : (isDestination ? {
          text: 'END',
          color: '#FFFFFF',
          fontSize: '8px',
          fontWeight: 'bold'
        ...
        <div className="relative h-full flex items-center justify-center">
          ...
          <div className="absolute top-1/3 left-1/4 transform -translate-x-1/2 -translate-y-1/2">
            ...
            <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 whitespace-nowrap">
              <div className="text-xs font-bold text-green-700 bg-white px-3 py-1.5 rounded-md shadow-md border-2 border-white">JOHN</div>
            </div>
          </div>
          ...
          <div className="absolute top-2/3 right-1/4 transform -translate-x-1/2 -translate-y-1/2">
            ...
            <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 whitespace-nowrap">
              <div className="text-xs font-bold text-green-700 bg-white px-3 py-1.5 rounded-md shadow-md border-2 border-white">SARAH</div>
            </div>
          </div>
