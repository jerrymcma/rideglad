  ...
  const renderBookingStep = () => (
    <div className="space-y-3">
      <div className="text-center space-y-1">
        <h1 className="text-[#285aeb] text-[30px] font-bold pt-[1px] pb-[1px] mb-2">Book a ride</h1>
        <p className="text-gray-600 mt-[1px] mb-[1px] text-left">Where would you like to go?</p>
      </div>

      <form onSubmit={handleRequestRide} className="space-y-4">
        <div className="space-y-2 relative">
          <Label htmlFor="pickup" className="peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-blue-600 text-base flex items-center gap-2 font-semibold">
            <MapPin size={16} />
            Pickup Location
          </Label>
          <Input
        ...
        <div className="space-y-2 relative">
          <Label htmlFor="destination" className="peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-blue-600 text-base flex items-center gap-2 font-semibold">
            <Navigation size={16} />
            Destination
          </Label>
          <Input
          ...
          <div className="flex justify-center">
            <div className="flex flex-col items-center gap-2">
                ...
                {requestRideMutation.isPending ? (
                  ...
                  <div className="relative flex items-center justify-center">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <Car size={38} className="text-white transform -translate-y-1" />
                    </div>
                  </div>
                )}
              </button>
              <p 
                ...
                onClick={() => requestRideMutation.mutate(bookingForm)}
  ...
  const renderMatchedStep = () => (
    <div className="space-y-4">
      <div className="text-center space-y-1 -mt-6 mb-1">
        <h2 className="font-bold text-blue-600 text-[22px] mt-[0px] mb-[0px] pt-[0px] pb-[0px]">Your driver is on the way!</h2>
      </div>
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-yellow-600 font-medium text-[12px]">Gold Status</span>
                    </div>
                  </div>
                  <div className="flex items-center mt-1">
                    <div className="flex items-center gap-1 mr-3">
                      <Star size={16} className="text-yellow-500 fill-current" />
                      <span className="font-semibold text-[13px]">{matchedDriver.rating} ({matchedDriver.driver.totalRatings} rides)</span>
                    </div>
                    <div className="flex items-center gap-1">
                      <Award size={16} className="text-blue-500 fill-current" />
                      <span className="text-blue-600 font-medium text-[12px]">ride Certified</span>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div className="space-y-2 -mt-2">
      ...
      {currentTrip && (
        <div className="flex justify-center">
          <Card className="max-w-md">
            <CardContent className="px-8 pt-4 pb-4 space-y-4">
      ...
      <div className="space-y-4">
        <div className="text-center space-y-3">
          ...
          <p className="text-[15px] text-[#1743e3] font-semibold">
        ...
        {/* Add Comment Button */}
        <div className="flex justify-center mt-[5px] mb-[5px]">
          <button
            type="button"
      ...
      <div className="p-6 space-y-6">
        ...
        {currentStep !== 'booking' && (
          <div className="flex items-center justify-center gap-2 py-2 pt-[12px] pb-[12px]">
            ...
            <div className={`w-2 h-2 rounded-full ${currentStep === 'inprogress' ? 'bg-blue-600' : 'bg-white/60'}`}></div>
            <div className={`w-2 h-2 rounded-full ${currentStep === 'rating' ? 'bg-blue-600' : 'bg-white/60'}`}></div>
          </div>
        )}
