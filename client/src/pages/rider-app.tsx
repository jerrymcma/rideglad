        ...
        <CardContent className="pb-4 pt-4 space-y-4">
          <div>
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center">
                  <h3 className="font-semibold mr-1 text-blue-600 leading-tight">{matchedDriver?.driver.firstName || 'John'} {matchedDriver?.driver.lastName || 'Driver'}</h3>
                  <div className="flex items-center gap-1">
                    <Trophy size={14} className="text-yellow-500 fill-current" />
                    <span className="text-xs text-yellow-600 font-medium">Gold Status</span>
                  </div>
                ...
                <div className="flex items-center mt-0.5">
                  <div className="flex items-center gap-1 mr-4">
                    <Star size={14} className="text-yellow-500 fill-current" />
                    <span className="text-xs whitespace-nowrap" style={{fontSize: '13px'}}>{matchedDriver?.rating || '4.8'} ({matchedDriver?.driver.totalRatings || '120'} rides)</span>
                  </div>
                  <div className="flex items-center gap-1">
