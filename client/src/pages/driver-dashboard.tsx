            ...
            <div className="text-center space-y-4">
              <div>
                ...
                <p className={`text-[15px] font-medium ${isOnline ? 'text-green-700' : 'text-blue-700'}`}>
                  {isOnline ? 'You are available for rides' : <span className="font-bold">You're offline</span>}
                </p>
              </div>
            ...
            <CardContent>
              {ridesLoading ? (
                ...
                <div className="text-center py-2">
                  ...
                  <p className="text-gray-500 text-[15px]">Requests would appear here</p>
                  <p className="text-gray-500 text-[14px]">{isConnected ? '(Real-time updates active)' : '(Connecting...)'} </p>
                </div>
              ) : (
        ...
        {!isOnline && (
          <Card className="border-gray-200">
            <CardContent className="pt-6 text-center">
              ...
              <p className="text-sm text-gray-400">Turn on driver mode to receive ride requests</p>
            </CardContent>
          </Card>
        )}
