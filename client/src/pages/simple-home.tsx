          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <div className="text-center pb-0 pt-3 px-6">
                ...
                <h3 className="text-brand-green text-[16px] font-bold">Book a ride</h3>
              </div>
            ...
            >
              <div className="text-center pb-0 pt-3 px-6">
                ...
                <h3 className="text-blue-600 -mt-1 text-[16px] font-bold">Drive + Earn</h3>
              </div>
              <div className="text-center py-1 pb-3 px-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <div className="text-center pb-0 pt-3 px-6">
                ...
                <h3 className="font-semibold text-[16px] text-[#0ba342]">Wallet</h3>
              </div>
              <div className="text-center py-1 pb-3 px-6">
            ...
            >
              <div className="text-center pb-0 pt-3 px-6">
                ...
                <h3 className="text-blue-600 text-[15px] font-extrabold">Advanced GPS</h3>
              </div>
              <div className="text-center py-1 pb-3 px-6">
