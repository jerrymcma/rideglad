        ...
        <div className="text-center space-y-1 pt-[0px] pb-[0px] mt-[2px] mb-[2px]">
          <div className="flex justify-center mb-1">
            <img 
              src={logoImage} 
              alt="ride - Get there.™"
              className="w-56 h-auto mt-[0px] mb-[0px] pt-[0px] pb-[0px] pl-[0px] pr-[0px]"
            />
          </div>
          
          <p className="text-gray-600 italic mt-1 pt-[10px] pb-[10px] text-[18px] font-semibold" style={{fontFamily: 'Cambria, serif'}}>It's our pleasure to assist you...</p>
        </div>
