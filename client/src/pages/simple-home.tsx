      ...
      <div className="p-6 text-[15px] pb-20">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div 
              className="cursor-pointer hover:shadow-md transition-shadow border-2 border-[#60a5fa] rounded-lg h-full bg-white"
              onClick={(e) => {
                e.preventDefault();
                e.stopPropagation();
            ...
            >
              <div className="text-center pb-0 pt-3 px-6">
                <div className="flex justify-center mb-1">
                  <Satellite size={36} className="text-[#60a5fa]" />
                </div>
                <h3 className="text-[#60a5fa] text-[15px] font-semibold">Advanced GPS</h3>
              </div>
              <div className="text-center py-1 pb-3 px-6">
