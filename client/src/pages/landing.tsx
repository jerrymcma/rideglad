        ...
        <div className="text-center space-y-10">
          ...
          <div className="flex justify-center">
            <img 
              src={logoImage} 
              alt="ride - Get there.™"
              className="w-64 h-auto ml-[0px] mr-[0px] mt-[0px] mb-[0px] pt-[0px] pb-[0px] pl-[32px] pr-[32px]"
            ...
            <div className="flex justify-center mt-3">
              <button
                onClick={() => {
                  toast({
                    title: "Password Help",
                    description: "Use simple passwords (6+ letters/numbers). Or try Google/Apple login below. Contact: help@rideshare.com",
                    duration: 8000,
                  });
                }}
