          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-center mt-4">
              <Button
                onClick={() => window.location.href = '/api/login'}
                variant="outline"
                className="w-32 h-10 border border-gray-300 text-gray-700 rounded font-medium hover:bg-gray-50 text-xs flex items-center justify-center gap-1 px-2"
              ...
              >
                ...
                <span className="text-xs whitespace-nowrap">Continue with Google</span>
              </Button>
            </div>
          </div>
        </div>
